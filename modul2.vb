...
Public Class modul2
    ...
    Public Function OpenConn() As Boolean
        Cn = New MySqlConnection("server=localhost;User Id=root;database=dbkaryawan;Convert Zero Datetime=True")
        Cn.Open()
    ...
    Public Function ExecuteQuery(ByVal Query As String) As DataTable
        Try
            Using Cn As New MySqlConnection("server=localhost;User Id=root;database=dbkaryawan;Convert Zero Datetime=True")
                Cn.Open()
                Cmd = New MySqlCommand(Query, Cn)
