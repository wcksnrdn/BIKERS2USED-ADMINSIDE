...
Public Class loginuplvl
    ...
    Private Sub Btnlogin1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btnlogin1.Click
        ...
        If Not String.IsNullOrEmpty(NIK) AndAlso Not String.IsNullOrEmpty(PIN) Then
            If IsLoginValid(NIK, PIN) Then
                ...
                If Not String.IsNullOrEmpty(jabatan) Then
                    ...
                    Dim jabatanDiperbolehkan As List(Of String) = New List(Of String) From {"Manager Accounting", "Presiden Director", "Chief Executive Officer", "Manager Software Engineer", "Cyber Security", "Human Resources Development", "Finance Consultant", "Project Manager"}
    ...
    Private Function GetFullnameByUsername(ByVal username As String) As String
        ...
        End Try
    End Function
    Private Sub Btnlogin_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Btnlogin1.Cursor = Cursors.Hand
    End Sub

    Private Sub Btnlogin_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Btnlogin1.Cursor = Cursors.Default
    End Sub
    ...
    Private Sub loginuplvl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtPassword.PasswordChar = "*"
    End Sub
